package com.gradlic.buysell.firebaseauth;
...
//                getActivity().finish();
    ...
    private void sendEmailToSeller() {
        String email = sEmail;
        String subject = "[LocalMart] Request for product " + pName;

        String msg = "unknown-user";
        if (bName != "")
            msg = bName;
        String thankMsg = "\n\nThank you for using LocalMart :)";
    ...
    private void sendEmailToBuyer() {
        String email = bEmail;
        String subject = "[LocalMart] Request Successful for " + pName;
        String thankMsg = "\n\nThank you for using LocalMart :)";
        String autoMsg = "\n\nThis is an auto generated email. Please do not reply to this email.";
